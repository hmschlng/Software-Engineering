...
- 이들은 시스템의 안정성, 응답 시간 및 저장 용량 요구 사항 등 시스템 속성과 제약 조건을 정의합니다. 제약 조건은 I/O 장치 기능, 시스템 표현 등입니다.
<br>
...
#### 비기능적 요구사항의 구현
- 기능 외 요구 사항은 개별 구성 요소보다 **시스템의 전체 아키텍처에 영향**을 줄 수 있습니다.
...
- 목표
  - 사용의 용이성과 같은 사용자의 일반적인 의도입니다.
<br>

- 검증 가능한 비기능 요구사항
  - 비기능적 요구사항을 나타낼 때(특히 시스템 요구사항), 객관적으로 테스트할 수 있는 몇 가지 척도를 사용하여 진술하는 것이 좋습니다.
<br>
