...
### ✅ Interviewing (인터뷰)
- 이해 관계자와의 공식 또는 비공식 인터뷰는 대부분의 RE 프로세스의 일부입니다.
- 면접유형
  - 미리 정해진 질문 목록을 기반으로 한 비공개 인터뷰
  - 다양한 이슈를 이해관계자와 함께 탐구하는 공개 인터뷰.
- 효과적인 면접
...
#### 실무에서의 인터뷰
- 일반적으로 비공개 인터뷰와 개방형 인터뷰가 혼합되어 있습니다.
- 인터뷰는 이해 관계자가 무엇을 하고 시스템과 상호 작용할 수 있는지에 대한 전반적인 이해를 얻는 데 유용합니다.
...
### ✅ 스토리와 시나리오
- 시나리오와 사용자 스토리는 시스템 사용 방법의 실제 예입니다.
- 스토리와 시나리오는 시스템이 특정 작업에 어떻게 사용될 수 있는지에 대한 설명입니다.
- 실제 상황을 기반으로 하기 때문에 이해관계자가 스토리에 공감하고 상황에 대해 논평할 수 있습니다.
<br>
